...
import { type CartItem,type Cosmetic } from "../types/type";
...
export default function DetailsPage () {
    ...
    const handleAddToCart = () => {
      if (cosmetic) {
        ...
        if (itemExists) {
          alert("Product sudah tersedia di Keranjang");
          setIsAdding(false);
        }else {
    ...
    <div className="flex flex-col gap-5">
          ...
          {cosmetic.photos.length > 0 ? (
            ...
            <div key={photo.id} className={`h-[72px] w-[72px] rounded-full
             ...
             p-[2px] transition-all duration-300`}>
              ...
              <p>No addtional photos available</p>
            )}
      ...
      <section id="Reviews">
        <div id="ReviewsSlider" className="swiper w-full overflow-x-hidden">
          ...
          <p> Not found data testimonial </p>
        )}
          </Swiper>
        </div>
      </section>
