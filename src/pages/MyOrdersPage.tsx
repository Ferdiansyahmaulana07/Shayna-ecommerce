...
export default function MyOrdersPage() {
    ...
    try {
        ...
        if(response.status === 200 && response.data.data){
            //Navigate ke halaman booking details with booking data if found
            navigate("/my-booking", {state: {bookingDetails: response.data.data, notFound: false}});
        }else {
            //Navigate to booking details page with noutfound flag if not found 
